...
using Raspberry.IO.Components.NetStandard.Controllers.Pca9685;
using Raspberry.IO.GeneralPurpose.NetStandard;
using Raspberry.IO.InterIntegratedCircuit.NetStandard;
using Test.Gpio.PCA9685;
using UnitsNet;

namespace Test.Gpio.Pca9685.NetCore
{
    /// <summary>
    ...
    class Program
    {
        ...
        private static Pca9685Options ParseOptions(IEnumerable<string> arguments)
        {
            ...
            // todo: find a way to replace NDesk
