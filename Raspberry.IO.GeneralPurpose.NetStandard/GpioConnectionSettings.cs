...
namespace Raspberry.IO.GeneralPurpose.NetStandard
{
    ...
    public class GpioConnectionSettings
    {
        ...
        private static readonly double _defaultPollInterval = 50;
        ...
        public static TimeSpan DefaultPollInterval
        {
            get
            {
                return TimeSpan.FromMilliseconds(_defaultPollInterval);
        ...
        public static ConnectorPinout ConnectorPinout
        {
            get
            {
                // todo: Find a way to manually configure this
                //var configurationSection = ConfigurationManager.GetSection("gpioConnection") as GpioConnectionConfigurationSection;
                //if (configurationSection != null)
                //{
                //    switch (Board.Current.ConnectorPinout)
                //    {
                //        case 1:
        ...
        public static IGpioConnectionDriver DefaultDriver
        {
            get
            {
                ...
                // todo: Find actual implementation / configuration 
                //var configurationSection = ConfigurationManager.GetSection("gpioConnection") as GpioConnectionConfigurationSection;
