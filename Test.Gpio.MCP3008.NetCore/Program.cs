...
using Raspberry.IO.Components.NetStandard.Converters.Mcp3008;
using Raspberry.IO.Components.NetStandard.Sensors;
using Raspberry.IO.Components.NetStandard.Sensors.Temperature.Tmp36;
using Raspberry.IO.GeneralPurpose.NetStandard;
using UnitsNet;

#endregion

namespace Test.Gpio.MCP3008.NetCore
{
    /// <summary>
